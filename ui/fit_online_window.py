...
class FitOnlineWindow(QDialog):
    ...
    def _init_ui(self):
        ...
        self.cb_fit_type.setSizePolicy(
            QSizePolicy.Expanding, QSizePolicy.Fixed)
        ...
        self.line_edit_fit_path.setSizePolicy(
            QSizePolicy.Expanding, QSizePolicy.Fixed)
    ...
    def start_fit_online(self):
        try:
            ...
            if self.cb_fit_type.currentText == 'circle':
                ...
                self.fit_online_thread.finished.connect(
                    self.on_fitonline_finished)
                self.fit_online_thread.error.connect(self.on_fitoneline_error)
                self.fit_online_thread.status_update.connect(
                    self.update_status)
