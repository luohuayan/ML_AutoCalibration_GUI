...
class MonoCalibrationColorCameraWindow(QDialog):
    ...
    def _init_ui(self):
        ...
        grid_layout.addWidget(self.label_gray_range, 9, 0)
        ...
        grid_layout.addWidget(self.line_edit_image_size, 12, 0)

        self.label_roi_size = QLabel()
        self.label_roi_size.setText("ROI宽高：例如200 200，以空格隔开")
        grid_layout.addWidget(self.label_roi_size, 13, 0)
        ...
        grid_layout.addWidget(self.line_edit_roi_size, 14, 0)
        ...
        grid_layout.addLayout(h_layout, 15, 0)

        self.label_path = QLabel()
        self.label_path.setText("保存路径(excel保存位置):")
        grid_layout.addWidget(self.label_path, 16, 0)
        ...
        grid_layout.addWidget(self.line_edit_path, 17, 0)

        self.btn_browse = QPushButton("浏览...")
        self.btn_browse.clicked.connect(self._open_folder_dialog)
        grid_layout.addWidget(self.btn_browse, 17, 1)
        ...
        grid_layout.addWidget(self.line_edit_eye1_path,19,0)
    ...
    def start_mono_calibration(self):
        try:
            ...
            self.luminance=float(self.line_edit_luminance_lum.text())
