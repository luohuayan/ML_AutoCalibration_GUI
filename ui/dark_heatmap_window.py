...
class DarkHeatMapWindow(QDialog):
    ...
    def _init_ui(self):
        ...
        self.line_edit_filename.setSizePolicy(
            QSizePolicy.Expanding, QSizePolicy.Fixed)
    ...
    def start_capture(self):
        try:
            ...
            self.darkheatmapThread.finished.connect(
                self.on_darkheatmap_finished)
