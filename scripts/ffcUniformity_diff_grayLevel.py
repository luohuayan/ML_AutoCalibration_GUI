...
def ffc_uniformity(input_path: str, out_path: str, xyz_list: List, image_name_list: List, gray_list: List, half_size: int,
                   binn_list: List, grayscale_dict: Dict, roi_dict: Dict[mlcm.Binning, List[mlcm.pyCVRect]]):
    uniformity_xlsx = out_path + "\\FFC_"
